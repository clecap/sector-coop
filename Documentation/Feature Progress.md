...
Central authority can use a UI to add new patrons | | #Blockchain #UserClient | ![White](/Documentation/Graphics/Circles/purple.png)
...
User data can be exported locally  | | #UserClient |![White](/Documentation/Graphics/Circles/purple.png)
