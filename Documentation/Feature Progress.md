...
A user can verify integrity of a document  | Smart Contract will save document hash but is still in development. Document file names are their SHA256 Hashes. | #UserClient #Blockchain |![Yellow](/Documentation/Graphics/Circles/yellow.png)
Identifier in the system can be linked to ORCID | | #Blockchain #UserClient |![White](/Documentation/Graphics/Circles/purple.png)
Frontend user client for users | Raw html pages exist for very basic interactions, does not incorporate fancy CSS yet. | #UserClient |![Yellow](/Documentation/Graphics/Circles/yellow.png)
...
Blind signature can be used to sign a pseudonym | RSA Blind signatures work outside of smart contract, smart contract integration is being developed. | #UserClient #Blockchain |![Green](/Documentation/Graphics/Circles/green.png)
...
Pseudonym is granted tokens | Smart Contract feature to grant tokens is being developed| #Blockchain | ![Green](/Documentation/Graphics/Circles/green.png)
...
Document storage checks on the blockchain for document hash | | #DocumentDB #Blockchain |  ![White](/Documentation/Graphics/Circles/purple.png)
...
User can create an identity (keypair)  |  | #UserClient |![Green](/Documentation/Graphics/Circles/green.png)
